...
const SHOWERS = [
  {
    ...
    name: "Quadrantids",
    peak: { m: 1, d: 3 },
    active: { m: 12, d: 28, endM: 1, endD: 12 },
    zhr: 110,
    radiant: "Boötes",
    parent: "2003 EH1",
  },
  {
    ...
    name: "Lyrids",
    peak: { m: 4, d: 22 },
    active: { m: 4, d: 14, endM: 4, endD: 30 },
    zhr: 18,
    radiant: "Lyra",
    parent: "C/1861 G1",
  },
  {
    ...
    name: "Eta Aquariids",
    peak: { m: 5, d: 6 },
    active: { m: 4, d: 19, endM: 5, endD: 28 },
    zhr: 50,
    radiant: "Aquarius",
    parent: "1P/Halley",
  },
  ...
  },
  {
    ...
    peak: { m: 7, d: 30 },
    active: { m: 7, d: 12, endM: 8, endD: 23 },
    zhr: 25,
    radiant: "Aquarius",
    parent: "96P/Machholz",
  },
  {
    ...
    name: "Perseids",
    peak: { m: 8, d: 12 },
    active: { m: 7, d: 17, endM: 8, endD: 24 },
    zhr: 100,
    radiant: "Perseus",
  ...
  },
  {
    ...
    name: "Draconids",
    peak: { m: 10, d: 9 },
    active: { m: 10, d: 6, endM: 10, endD: 10 },
    zhr: 10,
    radiant: "Draco",
  ...
  },
  {
    ...
    name: "Orionids",
    peak: { m: 10, d: 21 },
    active: { m: 10, d: 2, endM: 11, endD: 7 },
    zhr: 20,
    radiant: "Orion",
    parent: "1P/Halley",
  },
  {
    ...
    name: "S. Taurids",
    peak: { m: 11, d: 5 },
    active: { m: 9, d: 20, endM: 11, endD: 20 },
    zhr: 5,
    radiant: "Taurus",
    parent: "2P/Encke",
  },
  {
    ...
    name: "N. Taurids",
    peak: { m: 11, d: 12 },
    active: { m: 10, d: 20, endM: 12, endD: 10 },
    zhr: 5,
    radiant: "Taurus",
    parent: "2P/Encke",
  },
  {
    ...
    name: "Leonids",
    peak: { m: 11, d: 17 },
    active: { m: 11, d: 6, endM: 11, endD: 30 },
    zhr: 15,
    radiant: "Leo",
  ...
  },
  {
    ...
    name: "Geminids",
    peak: { m: 12, d: 14 },
    active: { m: 12, d: 4, endM: 12, endD: 20 },
    zhr: 150,
    radiant: "Gemini",
  ...
  },
  {
    ...
    name: "Ursids",
    peak: { m: 12, d: 22 },
    active: { m: 12, d: 17, endM: 12, endD: 26 },
    zhr: 10,
    radiant: "Ursa Minor",
    parent: "8P/Tuttle",
  },
  ...
  return ok(
    {
      ...
      next: upcoming.map((s) => ({
        ...
        zhr: s.zhr,
        peak_date: s.peak_date,
        days_until_peak: s.days_until_peak,
        radiant: s.radiant,
      })),
      calendar: resolved,
    },
